...
train_iter, val_iter, test_iter = NamedBpttIterator.splits(
    (train, val, test), batch_size=100, device=device, bptt_len=bptt_len, repeat=False)

class NNmodel(nn.Module):
    def __init__(self, embedding_size=128, hidden_size=512, vocab_size=1002, bptt_len=bptt_len, use_pretrained=False):
...
if __name__ == "__main__":
    ...
    model = NNmodel(vocab_size=TEXT.vocab.vectors.size()[0],
